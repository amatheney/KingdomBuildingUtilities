...
namespace KingmakerResourceViewer
{
    ...
    public class SettlementMods
    {
        ...
        public int settlementCrimeModifier;
        public int settlementLawModifier;
        public int settlementLoreModifier;
        public int settlementSocietyModifier;
        public int settlementDangerModifier;
        public int settlementProductivityModifier;
        public int settlementBaseValueModifier;
